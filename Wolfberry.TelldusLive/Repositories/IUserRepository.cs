...
namespace Wolfberry.TelldusLive.Repositories
{
    ...
    {
        Task<List<SmsHistoryEntry>> GetSmsHistoryAsync(string format = Constraints.JsonFormat);
        ...
        /// <param name="format">json (default) or xml</param>
        /// <returns></returns>
        Task<EulaResponse> GetEulaAsync(string format = Constraints.JsonFormat);
        ...
        /// <param name="format">json (default) or xml</param>
        /// <returns></returns>
        Task<object> GetLinkedAccountsAsync(string format = Constraints.JsonFormat);
